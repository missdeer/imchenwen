...
public:
    ...
    QList<QNetworkProxy> queryProxy(const QNetworkProxyQuery &query) override
    {
        ...
        if (host == QStringLiteral("localhost") || host == QStringLiteral("ip6-localhost") || host == QStringLiteral("ip6-loopback") ||
...
NetworkAccessManager::NetworkAccessManager(QObject *parent) : QNetworkAccessManager(parent), m_proxyFactory(new ProxyFactory)
{
