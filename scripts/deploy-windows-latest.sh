...
# Bundle OpenSSL
curl -Lo openssl.7z https://download.qt.io/online/qtsdkrepository/windows_x86/desktop/tools_opensslv3_x64/qt.tools.opensslv3.win_x64/3.0.16-1openssl_3.0.16_prebuild_x64.7z
7z e openssl.7z -oimchenwen Tools/OpenSSLv3/Win_x64/bin/*.dll

# Bundle ffmpeg
curl -Lo ffmpeg.7z https://www.gyan.dev/ffmpeg/builds/packages/ffmpeg-7.1.1-essentials_build.7z
7z e ffmpeg.7z -oimchenwen ffmpeg-7.1.1-essentials_build/bin/ffmpeg.exe
